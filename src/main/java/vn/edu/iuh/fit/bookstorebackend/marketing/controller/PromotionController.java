...
import vn.edu.iuh.fit.bookstorebackend.marketing.service.PromotionService;
...
public class PromotionController {
    ...
    public ResponseEntity<PromotionResponse> createPromotion(
            @RequestBody CreatePromotionRequest request) throws IdInvalidException {
    ...
    public ResponseEntity<List<PromotionResponse>> searchPromotions(
        ...
        List<PromotionResponse> promotions = promotionService.searchPromotions(
                name, code, status, isActive);
        return ResponseEntity.status(HttpStatus.OK).body(promotions);
    }

    @GetMapping("/validate/{code}")
    public ResponseEntity<Map<String, Boolean>> validatePromotionCode(
    ...
    public ResponseEntity<PromotionResponse> getPromotionById(
            @PathVariable Long promotionId) throws IdInvalidException {
        PromotionResponse promotionResponse = promotionService.getPromotionById(
                promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(promotionResponse);
    }

    @PatchMapping("/{promotionId}/approve")
    public ResponseEntity<PromotionResponse> approvePromotion(
            @PathVariable Long promotionId) throws IdInvalidException {
        PromotionResponse promotionResponse = promotionService.approvePromotion(
                promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(promotionResponse);
    }
    ...
    public ResponseEntity<PromotionResponse> deactivatePromotion(
            @PathVariable Long promotionId) throws IdInvalidException {
        PromotionResponse promotionResponse = promotionService.deactivatePromotion(
                promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(promotionResponse);
    }
    ...
    public ResponseEntity<PromotionResponse> pausePromotion(
            @PathVariable Long promotionId) throws IdInvalidException {
        PromotionResponse promotionResponse = promotionService.pausePromotion(
                promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(promotionResponse);
    }
    ...
    public ResponseEntity<PromotionResponse> resumePromotion(
            @PathVariable Long promotionId) throws IdInvalidException {
        PromotionResponse promotionResponse = promotionService.resumePromotion(
                promotionId);
        return ResponseEntity.status(HttpStatus.OK).body(promotionResponse);
    }

    @PostMapping("/{promotionId}/notify-paused")
    public ResponseEntity<Map<String, String>> notifyPromotionPaused(
            @PathVariable Long promotionId) throws IdInvalidException {
    ...
    public ResponseEntity<Map<String, String>> notifyActiveCustomers(
            @PathVariable Long promotionId) throws IdInvalidException {
    ...
    public ResponseEntity<Map<String, String>> notifyPromotionResumed(
            @PathVariable Long promotionId) throws IdInvalidException {
