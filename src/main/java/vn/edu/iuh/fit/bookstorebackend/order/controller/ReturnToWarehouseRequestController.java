package vn.edu.iuh.fit.bookstorebackend.order.controller;
...
public class ReturnToWarehouseRequestController {
    ...
    public ResponseEntity<ReturnToWarehouseRequestResponse> createReturnToWarehouseRequest(
            @Valid @RequestBody CreateReturnToWarehouseRequestRequest request) throws IdInvalidException {
    ...
    public ResponseEntity<ReturnToWarehouseRequestResponse> approveReturnToWarehouseRequest(
            ...
            @Valid @RequestBody ProcessReturnToWarehouseRequestRequest request) throws IdInvalidException {
