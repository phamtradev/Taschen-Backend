package vn.edu.iuh.fit.bookstorebackend.marketing.service.impl;
...
import vn.edu.iuh.fit.bookstorebackend.marketing.mapper.BannerMapper;
import vn.edu.iuh.fit.bookstorebackend.marketing.model.Banner;
import vn.edu.iuh.fit.bookstorebackend.marketing.repository.BannerRepository;
...
public class BannerServiceImpl implements BannerService {
    ...
    public BannerResponse createBanner(BannerRequest request) throws IdInvalidException {
        ...
        banner.setTag(request.getTag() != null && !request.getTag().trim().isEmpty() ? request.getTag().trim() : "Featured");
