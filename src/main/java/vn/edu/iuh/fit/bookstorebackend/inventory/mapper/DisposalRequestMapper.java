package vn.edu.iuh.fit.bookstorebackend.inventory.mapper;

import org.mapstruct.Mapper;
import org.mapstruct.Mapping;
import org.mapstruct.Named;
import vn.edu.iuh.fit.bookstorebackend.inventory.dto.response.BatchResponse;
import vn.edu.iuh.fit.bookstorebackend.inventory.dto.response.DisposalRequestItemResponse;
...
public interface DisposalRequestMapper {
    ...
    default DisposalRequestResponse.UserInfo mapUserToUserInfo(User user) {
        if (user == null) {
            return null;
        }
        return DisposalRequestResponse.UserInfo.builder()
                .id(user.getId())
                .email(user.getEmail())
                .build();
    }
